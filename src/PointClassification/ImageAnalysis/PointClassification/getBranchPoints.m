function branchPoints = getBranchPoints(image)
% GET BRANCH POINT
...
%
% To get the ANCHOR BRANCH POINT it is enough to access to the fifth field of the
% third dimension array.

pointsMatrix = image.pointsMatrix;
branchPointMatrix = pointsMatrix(:,:,PointClassificationType.BRANCH_POINT);
[branchX, branchY] = find(branchPointMatrix == 1);
branchPoints = [branchX, branchY];