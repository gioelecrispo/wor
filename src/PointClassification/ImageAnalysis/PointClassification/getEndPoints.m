function endPoints = getEndPoints(image)
% GET END POINT
...
%
% To get the END POINT it is enough to access to the first field of the
% third dimension array.

pointsMatrix = image.pointsMatrix;
endPointMatrix = pointsMatrix(:,:,PointClassificationType.END_POINT);
[endX, endY] = find(endPointMatrix == 1);
endPoints = [endX, endY];