function falseTracePoints = getFalseTracePoints(image)
% GET FALSE TRACE POINT
...
%
% To get the FALSE TRACE POINT it is enough to access to the fourth field of the
% third dimension array.

pointsMatrix = image.pointsMatrix;
falseTracePointMatrix = pointsMatrix(:,:,PointClassificationType.FALSE_TRACE_POINT);
[falseTraceX, falseTraceY] = find(falseTracePointMatrix == 1);
falseTracePoints = [falseTraceX, falseTraceY];