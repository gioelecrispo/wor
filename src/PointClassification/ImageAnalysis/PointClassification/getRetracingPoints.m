function retracingPoints = getRetracingPoints(image)
% GET RETRACING POINT
...
%
% To get the RETRACING POINT it is enough to access to the second field of the
% third dimension array.

pointsMatrix = image.pointsMatrix;
retracingPointMatrix = pointsMatrix(:,:,PointClassificationType.RETRACING_POINT);
[retracingX, retracingY] = find(retracingPointMatrix == 1);
retracingPoints = [retracingX, retracingY];