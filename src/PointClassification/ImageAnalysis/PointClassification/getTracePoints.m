function tracePoints = getTracePoints(image)
% GET TRACE POINT
...
%
% To get the TRACE POINT it is enough to access to the third field of the
% third dimension array.

pointsMatrix = image.pointsMatrix;
tracePointMatrix = pointsMatrix(:,:,PointClassificationType.TRACE_POINT);
[traceX, traceY] = find(tracePointMatrix == 1);
tracePoints = [traceX, traceY];