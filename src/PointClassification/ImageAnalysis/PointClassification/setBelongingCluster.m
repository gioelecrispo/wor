function image = setBelongingCluster(image, point, belongingCluster)
% SET BELONGING CLUSTER
...
image.pointsMatrix(point(1), point(2), PointClassificationType.BELONGING_CLUSTER) = belongingCluster;
